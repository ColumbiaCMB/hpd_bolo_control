...
CHANNELS = 2
RATE = 100    # depends on sound card: 96000 might be possible
...
class Scope(Qwt.QwtPlot):
    ...
    def __init__(self, *args):
        ...
        self.avcount=0
        self.ds1 = collections.deque(maxlen=1000)
        self.ds2 = collections.deque(maxlen=1000)
        self.offset1=0.0
        self.offset2=0.0
...
class bolo_scope(threading.Thread):
    def __init__(self):
